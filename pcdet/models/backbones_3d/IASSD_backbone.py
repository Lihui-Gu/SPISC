            ...
            if self.layer_types[k] == 'SA_Layer':
                ...
                self.SA_modules.append(
                    pointnet2_modules.PointnetSAModuleMSG_WithSampling(
                        ...
                        sample_range_list=sa_config.SAMPLE_RANGE_LIST[k],  # [[-1], [-1], [-1], [-1], [-1], [-1]]
                        sample_type_list=sa_config.SAMPLE_METHOD_LIST[k],
                        # [['D-FPS'], ['D-FPS'], ['ctr_aware'], ['ctr_aware'], [], []]
                        radii=sa_config.RADIUS_LIST[k],  # [[0.2,0.8], [0.8,1.6], [1.6,4.8], [], [], [4.8, 6.4]]
                        nsamples=sa_config.NSAMPLE_LIST[k],  # [[16,32], [16,32], [16,32], [], [], [16, 32]]
                        mlps=mlps,
                        use_xyz=True,                                                
                        dilated_group=sa_config.DILATED_GROUP[k],  # [False, False, False, False, False, False]
